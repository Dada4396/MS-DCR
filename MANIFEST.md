...
- `ms_dcr.py`: source-checkout command-line entry point.
- `src/ms_dcr/core.py`: MS-DCR core implementation.
- `src/ms_dcr/__init__.py`: public package exports.
- `src/ms_dcr/__main__.py`: `python -m ms_dcr` entry point.
- `requirements.txt`: runtime Python dependencies.
- `pyproject.toml`: package metadata and console script configuration.
- `demo_data/demo_dia_32spectra.mzML`: small DIA mzML demo file derived from original data.
